var Fold = React.createClass({displayName: "Fold",
    ...
    render: function() {        
        ...
        for (var i = 0; i < count; i++) {
            ...
            s += i%2?cos:hh;
            Nodes[i] = React.createElement("div", {key: i, className: 'Sheet '+style, style: tempSheetStyle})
        }
        return (
                React.createElement("div", {className: "Fold", style: this.FoldStyle, onMouseOver: this.onMouseOver, onMouseOut: this.onMouseOut}, 
                    React.createElement("div", {className: "Text"}, this.state.text), 
                    Nodes
                ) 
        );
    }
...
ReactDOM.render(
    React.createElement(Fold, {src: "20339746.jpg", text: "HTML5"}),
